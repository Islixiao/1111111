...
public class Admin_Activitystu extends AppCompatActivity implements View.OnClickListener {

    private TextView textNum;
    private Button button;
    private ListView listView;
    private List<Student> list,newList;
    private Utildaodb dao;
    private Adapter_Adminstu adapter;
    private int listNum = 0;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.adminmanger);
        //初始化控件
        initWidget();
        //实例dao
        DbUtil();
    ...
    public void showListView(){
         ...
         * 创建并绑定适配器
         * */
        adapter = new Adapter_Adminstu(this,R.layout.admin_stuitem,list);
    ...
    public void dialogNormal(){
        ...
        DialogInterface.OnClickListener dialogOnClick = new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                Student userDel = list.get(listNum);
                switch (i){
                    case DialogInterface.BUTTON_POSITIVE:
                        dao.delData("name=?",new String[]{userDel.getName()});
                        refresh();
                        break;
    ...
    public void dialogList(){
        ...
        builder.setItems(items, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                //拿到当前选中项的 User 对象
                Student userNum = list.get(listNum);
                Intent intent;
                switch (i){
                    case 0: intent = new Intent(Admin_Activitystu.this,AlterData.class);
                        //传入当前选中项的姓名和电话以在编辑页面中显示在输入框中
                        intent.putExtra("name",userNum.getName().toString());
                        intent.putExtra("sid",userNum.getSid().toString());
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.main_button:
                ...
                Intent intent = new Intent(Admin_Activitystu.this,AddData.class);
        ...
        switch (requestCode){
            ...
            case 1:
                ...
                if(resultCode == RESULT_OK){
                    ...
                    dao.addData("student",key,values);
                }
                break;
            //请求码为2，表示点击了编辑按钮
            case 2:
