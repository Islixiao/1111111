...
import us.codecraft.webmagic.processor.PageProcessor;
     ...
     */
    public class AnimationProcessor implements PageProcessor {
       ...
       // private Site site = Site.me().setRetryTimes(3).setSleepTime(100);//.setCharset("utf8");
        ...
        public void process(Page page) {
           ...
           if (!page.getUrl().regex("https://movie.douban.com/tag/#/?sort=R&range=0,10&tags=%E5%8A%A8%E7%94%BB").match()) {
               // 添加所有文章页
               page.addTargetRequests(page.getHtml().xpath("//div[@id='list-wp']").links()// 限定文章列表获取区域
                       .regex("https://movie.douban.com/subject/\\d+")
                       .all());
              ...
              //  CsdnBlog csdnBlog = new CsdnBlog();
                ...
                // 把对象输出控制台
               ***/
                new AnimationDao().add(animation);
        ...
        public static void main(String[] args) {
            ...
            Spider.create(new AnimationProcessor()).addUrl("https://movie.douban.com/tag/#/?sort=T&range=0,10&tags=%E5%8A%A8%E7%94%BB").thread(5).run();
