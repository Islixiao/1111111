...
public class  DaAnimationDao {
    ...
    public int add(DaAutoHome hahadmAnimation) {
        try {
            String sql = "INSERT INTO `spider`.`daman_animationall_movie_1024` (`id`,`damanwebname`,`content`,`imgurl`, `url`, `vediourl`,`mainrole`,`area`, `tag`,`language`,`year`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);";
