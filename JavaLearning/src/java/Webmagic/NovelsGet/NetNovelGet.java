    ...
    public static void getNovel(String baseUrl, String nextUrl, String destFilePath) {
        try {
            ...
            while (!nextUrl.startsWith("/")) {
                ...
                // 获取目标url的response
                br = new BufferedReader(new InputStreamReader(new URL(realUrl).openStream(), Charset.forName("utf-8")));
                String line;
