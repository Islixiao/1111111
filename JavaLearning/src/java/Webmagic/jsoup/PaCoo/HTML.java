...
@Test
    //根据url从网络获取网页文本
    public Document getHtmlTextByUrl(String url) throws Exception{
        Document doc = null;
        try {
...
//根据本地路径获取网页文本，如果不存在就通过url从网络获取并保存
        public Document getHtmlTextByPath (String name, String url)throws Exception{
...
@Test
    //获取省 、市 、县等的信息
    public ArrayList getProvince(String name,String url ,String type)throws  Exception,IOException {
