...
public class CsdnBlogPageProcessor1 implements PageProcessor {
    ...
    public void process(Page page) {
        ...
        if (!page.getUrl().regex("http://blog\\.csdn\\.net/" + username + "/article/details/\\d+").match()) {
            ...
            CsdnBlog1 csdnBlog = new CsdnBlog1();
            // 设置编号
...
//            new CsdnBlogDao1().add(csdnBlog);
    ...
    public static void main(String[] args) {
        ...
        Spider.create(new CsdnBlogPageProcessor1()).addUrl("http://blog.csdn.net/" + username).thread(5).run();
