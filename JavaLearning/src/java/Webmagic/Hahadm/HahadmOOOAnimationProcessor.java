 ...
 *On 2017/10/21  ***19:47.
 ******/
public class HahadmOOOAnimationProcessor implements PageProcessor {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (String line11 : fithTest) {
            if (StringUtils.isNotBlank(line11)) {
                ...
                Spider.create(new HahadmOOOAnimationProcessor()).addUrl("http://www.hahadm.com/v/" + username1).thread(5).run();
